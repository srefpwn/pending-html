                                                ...
                                                <table align="center" class="table-border" width="100%">
                                                    ...
                                                    <tr>
														...
														<table id="items-table" align="center" class="servicestable2 table-border" style="width:100%;">
    														<tr>
        														<td class="epc-text p5" style="background-color:#bb271a;color:#ffffff;width:20%;">Cikkszám
        														</td>
        														<td class="epc-text p5" style="background-color:#bb271a;color:#ffffff;width:45%;">Megnevezés
        														</td>
