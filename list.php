                            ...
                            <tr>
                                ...
                                <table align="left" class="table-border" width="100%">
                                    <tr>
                                        ...
                                        <?php endif; ?>
                                        <?= htmlspecialchars( $isSearch ? 'Keresés: ' . $search : (string)($selectedCategory['name'] ?? '')) ?> - Szerviz kézikönyv</span>
                                        </span>
                                        </td>
                                    </tr>
                				<!-- Keresés -->
									...
									<tr>
										...
										<table align="center">
											<tr>
												<td><a href="?page=<?= urlencode($page) ?><?= $navigationParams ?>&category=all"><button type="submit">Javítási könyvek</button></a></td>
           										<td><a href="?page=<?= urlencode($page) ?><?= $navigationParams ?>&category=all"><button type="submit">Karosszéria-javítási könyvek</button></a></td>
											</tr>
										</table>
										</td>
									</tr>
