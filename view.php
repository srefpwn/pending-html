...
function convertManualLinks(
    ...
    . '&body_code=' . rawurlencode($bodyCode)
    . '&trim_code=' . rawurlencode($trimCode)
...
(function () {
    ...
    var modelCode = <?= json_encode($modelCode) ?>;
    var bodyCode  = <?= json_encode($bodyCode) ?>;
    var trimCode  = <?= json_encode($trimCode) ?>;
    var year      = <?= json_encode((string)$year) ?>;
    var carId     = <?= json_encode((string)$carId) ?>;

    function addParamsToIframeLinks(iframe) {
        ...
        try {
            ...
            links.forEach(function (link) {
                ...
                try {
                    ...
                    /*
                     * Ugyanúgy, ahogy eddig a car paramétert
                     * hozzáadtuk, most az aktuális manual
                     * paramétereit is hozzáadjuk.
                     */
    ...
    function processIframe(iframe) {
         ...
         */
        addParamsToIframeLinks(iframe);

        /*
         * Az iframe betöltése után is lefuttatjuk,
         * amikor a külső HTML már ténylegesen benne van.
         */
