                                                            ...
                                                            <tr>
                                                                <td style="padding:0px;background-color:#cccccc;">
                                                                    <table width="100%" class="text-center table-border">
                                                                    	<tr>
                                                                    		<td style="height:auto;padding:10px;background-color:#444444;"><span class="epc-title3"><?php if ($carName !== ''): ?><?= htmlspecialchars($car['name']) ?><?php else: ?><?= htmlspecialchars($carConfig['name']) ?><?php endif; ?></span>
                                                                    		</td>
                                                                    	</tr>
                                                                    </table>
                                                                            ...
                                                                            <table class="table-border text-right textv-top" style="height:100%;">
                                                                            	<tr>
                                                                            		...
                                                                            		<table class="table-border">
                                                                            			...
                                                                            			<tr>
                                                                            				<td style="height:30px;"><a href="/epc/?brand=<?= urlencode($carConfig['brand']) ?>&model=<?= urlencode($carConfig['model']) ?>&series=<?= urlencode($carConfig['series']) ?>&model_code=<?= urlencode($carConfig['model_code']) ?>&car=<?= (int)$car['id'] ?>&from_cars=<?= urlencode('/cars/') ?><?= $navigationParams ?>"><button style="width:140px" type="submit">EPC megnyitása</button></a>
                                                                            				</td>
                                                                            			</tr>
                                                                            			<?php endif; ?>
