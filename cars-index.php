...
$carOptions = $car_catalog[$brand]['models'][$model]['series'][$carConfig['series']]['options'] ?? [];
?>
                                                            <tr>
                                                                <td style="padding:0px;background-color:#cccccc;">
                                                                    <table width="100%" height="232" class="text-center table-border">
                                                                        <tr>
                                                                            <td style="width:360px;text-align:center; padding:20px;">
                                                                            <table class="table-border" style="text-align:center;">
                                                                            	<tr>
                                                                            		<td>
                                                                            		<?php if (!empty($carConfig['preview'])): ?>
                                                                            		<img src="<?= htmlspecialchars($carConfig['preview']) ?>" width="360">
                                                                           			<?php endif; ?>
                                                                           			</td>
                                                                           		</tr>
                                                                            	<tr>
                                                                            		<td style="padding:10px;background-color:#444444;">
                                                                            		<span class="epc-title3"><?php if ($carName !== ''): ?><?= htmlspecialchars($car['name']) ?><?php else: ?><?= htmlspecialchars($carConfig['name']) ?><?php endif; ?></span>
                                                                    				</td>
                                                                           		</tr>
                                                                           	</table>
                                                                            </td>
                                                                            ...
                                                                            <table class="table-border" width="100%">
                                                                            	...
                                                                            	<tr>
                                                                            		...
                                                                            		<span class="epc-text2"><b>Márka: </b></span>
                                                                            		</td>
                                                                            		<td style="height:auto;padding:10px;text-align:right;">
                                                                            		<span class="epc-text2"><?= htmlspecialchars($car_catalog[$brand]['name'] ?? '') ?></span>
                                                                            		</td>
                                                                            	</tr>
                                                                            	<tr>
                                                                            		<td style="height:auto;padding:10px;" class="car-list">
                                                                            		<span class="epc-text2"><b>Típus: </b></span>
                                                                            		</td>
                                                                            		<td style="height:auto;padding:10px;text-align:right;" class="car-list">
                                                                            		<span class="epc-text2"><?= htmlspecialchars($car_catalog[$brand]['models'][$model]['name'] ?? '') ?></span>
                                                                            		</td>
                                                                            	</tr>
                                                                            	<tr>
                                                                            		<td style="height:auto;padding:10px;">
                                                                            ...
                                                                            <table class="table-border text-right textv-top" style="height:100%;">
                                                                            	<tr>
                                                                            		...
                                                                            		<table class="table-border">
                                                                            			...
                                                                            			<tr>
                                                                            				<td style="height:30px;"><a href="/epc/?brand=<?= urlencode($brand) ?>&model=<?= urlencode($model) ?>&series=<?= urlencode($carConfig['series']) ?>&model_code=<?= urlencode($carConfig['model_code']) ?>&body_code=<?= urlencode($carConfig['body_code']) ?>&trim_code=<?= urlencode($carConfig['trim_code']) ?>&car=<?= (int)$car['id'] ?>&from_cars=<?= urlencode('/cars/') ?><?= $navigationParams ?>"><button style="width:140px" type="submit">EPC megnyitása</button></a>
                                                                            				</td>
                                                                            			</tr>
                                                                            			<?php endif; ?>
                                                                            			<?php if (isCarManualEnabled($carConfig)): ?>
                                                                            			<tr>
                                                                            				<td style="height:30px;"><a href="/manual/?brand=<?= urlencode($brand) ?>&model=<?= urlencode($model) ?>&series=<?= urlencode($carConfig['series']) ?>&model_code=<?= urlencode($carConfig['model_code']) ?>&body_code=<?= urlencode($carConfig['body_code']) ?>&trim_code=<?= urlencode($carConfig['trim_code']) ?>&year=<?= htmlspecialchars($car['production_year']) ?>&car=<?= (int)$car['id'] ?>&from_cars=<?= urlencode('/cars/') ?><?= $navigationParams ?>"><button style="width:140px" type="submit">Szerviz Kézikönyv</button></a>
                                                                            				</td>
                                                                            			</tr>
                                                                            			<?php endif; ?>
                                                                            		</table>
                                                                            	...
                                                                            	<tr>
                                                                            		...
                                                                            		<table class="table-border">
    																					...
    																					<tr>
        																					<td>
																							<a href="/cars/edit.php?user_id=<?= (int)$userId ?>&car_id=<?= (int)$car['id'] ?>"><button style="width:140px" type="button">Szerkesztés</button></a>
        																					</td>
   																						</tr>
																						<?php endif; ?>
                                                                            			<tr>
